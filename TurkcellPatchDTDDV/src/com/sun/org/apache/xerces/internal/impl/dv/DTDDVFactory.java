...
/**
 * The factory to create and return DTD types. The implementation should store the created datatypes in static data, so that they can be shared by multiple
 ...
 */
/**
 * Java 1.7 de ObjectFactory.newInstance nedeniyle olusan classloading performans problemi icin Java 1.8 de yer alan bu class kullanilmistir Kullanimi : java
 * -Xbootclasspath/p:/TurkcellPatchDTDDV/exportLib/TurkcellPatchDTDDVForJava17.jar
 * 
 * @author guner
 *
 */
public abstract class DTDDVFactory {
	...
	static {
		System.out.println("Using Turkcell DTDDVFactory Patch For Java 1.7");
	}
	 ...
	 * @exception DVFactoryException cannot create an instance of the specified class name or the default class name
	 */
