/*
 * Client.java - JMX client that interacts with the JMX agent. It gets attributes and performs operations on the Hello MBean and the QueueSampler MXBean
 * example. It also listens for Hello MBean notifications.
 */
