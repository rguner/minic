 ...
 */
public class EncryptDecryptWithAESECB {

	private static final String textToEncrypt = "ramazan guner deneme";
	...
	public static void main(String[] args) {
		...
		String encyptStr = encrypt(textToEncrypt);
		String decryptStr = decrypt(encyptStr);

		System.out.println("Plain   String  : " + textToEncrypt);
